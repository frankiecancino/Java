...
public class PlayerController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        //Number of bands changed by a file menu with options loaded in from bandsList Integer array
        bandsText.setText(Integer.toString(numBands));
        
        //Adds Visulizers to an array list of type visualizers
        ...
        visualizers.add(new Fcb6fVisual());
        
        //Poppulates The visualizer menu with menu items from visulizers array list
        ...
        //populates Bands menu with bands list menu items from the bandsList (Integer) Array
    ...
    // Method for "on click" Menu item under Visualizer Menu that when clicked, uses the name of the Menu item to switch visualizers (Start)
    ...
    // Method for "on click" Menu item under Bands Menu that when clicked, uses the name of the Menu item to switch Bands
    private void selectBands(ActionEvent event) {
        ...
        // Method for "on click" Menu item under Visualizer Menu that when clicked, uses the name of the Menu item to switch visualizers (If one is already opened)
    ...
    //Opens Music and sets mediaPlayers Object Audio settings 
